...
public class BulletManager extends ParticularObjectManager {
    ...
    public void draw(bullet.DuckBullet duckBullet, Graphics2D g2) {
    ...
    public void draw(bullet.Flame flame, Graphics2D g2) {
    ...
    public void draw(bullet.LittleGirlBullet littleGirlBullet, Graphics2D g2) {
    ...
    public void draw(bullet.PlayerBullet playerBullet, Graphics2D g2) {
    ...
    public void draw(bullet.RedFlame1 redFlame1, Graphics2D g2) {
