...
import graphic.BulletManager;
import item.ItemDame;
import item.ItemHP;
import item.ItemHeart;
import graphic.ItemManager;
...
public class GameWorldState extends State {
    ...
    private void initEnemies1(){        
    	Enemy[] snail = new Snail[7];stateManager.getSnailImage();
        ...
        Enemy [] bull = new Bull[6];stateManager.getBullImage();
        ...
        Enemy[] slime = new Slime[3];stateManager.getSlimeImage();
        ...
        DarkDuck[] duck = new DarkDuck[10]; stateManager.getDarkDuckImage();
    ...
    private void updateMap() {
    	...
    	if( particularObjectManager.getCount() <= 100 && changeMap2 == true ) {
                ...
                synchronized(particularObjectManager.particularObjects){
                  ...
                  synchronized(bulletManager.particularObjects){
                      for(ParticularObject bullet: bulletManager.particularObjects)
                        ...
                        if (bullet instanceof bullet.DuckBullet) bulletManager.draw((DuckBullet) bullet,g2);
                        else if (bullet instanceof bullet.Flame) bulletManager.draw((Flame) bullet,g2);
                        else if (bullet instanceof bullet.LittleGirlBullet) bulletManager.draw((LittleGirlBullet) bullet,g2);
                        else if (bullet instanceof bullet.PlayerBullet) bulletManager.draw((PlayerBullet) bullet,g2);
                        else if (bullet instanceof bullet.RedFlame1) bulletManager.draw((RedFlame1) bullet,g2);
                        else if (bullet instanceof bullet.RedFlame2) bulletManager.draw((RedFlame2) bullet,g2);
                    }
                }
